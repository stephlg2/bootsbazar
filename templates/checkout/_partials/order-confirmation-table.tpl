      ...
      {block name='order_confirmation_table'}
          {foreach from=$products item=product}
            ...
            <span class="image">
              ...
              <div class="col-sm-4 col-9 details">
                  ...
                  <span>{$product.name}</span>
                      {if $add_product_link}</a>{/if}
                        <span class="visible--mobile quantite-mobile-confirmation">
                        {l s='Quantity' d='Shop.Theme.Catalog'} : {$product.quantity}<br>
                        {l s='Unit price' d='Shop.Theme.Catalog'} : {$product.price}
              ...
              <div class="col-sm-6 col-12 qty visible--desktop">
                <div class="row">
