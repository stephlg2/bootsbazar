        ...
        {foreach from=$orders item=order}
          <tr>
            ...
            <td class="text-sm-center">
              {if $order.factures_bc}
                {foreach from=$order.factures_bc item=facture_bc}
                  <a href="{$facture_bc}" target="_blank"><i class="material-icons">&#xE415;</i></a>
                {/foreach}
              {else if $order.facture_bc_en_cours}
                -
              {else if $order.details.invoice_url}
