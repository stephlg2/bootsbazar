...
<div class="tabs">
    <div class="js-mailalert text-center"
        ...
        {if empty($has_notification)}
            {if !empty($email)}
                <input id="notify_email" class="form-control" style="display: none" type="email"
            ...
            <button
                    ...
                    rel="nofollow"><i class="fa-light fa-circle-envelope"></i>
                <span id="text_email_notify">{l s='Notify me when available' d='Modules.Emailalerts.Shop'}</span>
                <span id="text_email_send" style="display: none">{l s='Send' d='Modules.Emailalerts.Shop'}</span>
            </button>
            <div class="js-mailalert-alerts"></div>
        {else}
            <article class="mt-1 alert alert-info"
                     role="alert">{l s='You already have an alert for this product' d='Modules.Emailalerts.Shop'}</article>
        {/if}
    </div>
</div>
