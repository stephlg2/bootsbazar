...
<div class="col-3 pl-0"><a href="{$mailAlert.link}" class="col-md-2 col-xs-4" style="text-align:center;">
...
<a href="{$mailAlert.link}" class="col-md-8 col-xs-6">
  <div>{$mailAlert.name}
    <span class="pointure-alert-mail">{l s='Size' d='Modules.Emailalerts.Shop'}: {$mailAlert.attributes_small}</span>
  </div>
</a>
</div>
</div>
