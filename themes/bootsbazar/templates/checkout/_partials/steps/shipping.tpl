         ...
         {if $delivery_options|count}
             ...
             >
                 <div class="form-fields">
                             ...
                             {foreach from=$delivery_options item=carrier key=carrier_id}
                                 <div class="row delivery-option">
                                             ...
                                             <div class="custom-radio float-xs-left">
                                                 ...
                                                 <label class="custom-control-label" for="delivery_option_{$carrier.id}"><span
                                                             class="sr-only">{$carrier.name}</span></label>
                                             </div>
                                        
                                         <label for="delivery_option_{$carrier.id}" class="col-10 col-md-11 delivery-option-2">
                                             <div class="row">
                                                 <div class="col-text">
                                                     <div class="row carrier has-logo">
                                                         {if $carrier.logo}
                                                             <div class="col-3 carrier-logo ">
                                                                 <img src="{$carrier.logo}" alt="{$carrier.name}"/>
                                                             </div>
                                                         {/if}
                                                         <div class="{if $carrier.logo}col-9{else}col-12{/if}  carrier-name-container col-9">
                                                 ...
                                                 <div class="carrier-price-wrapper">
                     ...
                     {hook h='displayCarrierBeforeContinue'}
                 </div>
                 <button type="submit" class="continue btn btn-primary btn-lg mt-3" name="confirmDeliveryOption"
                         value="1">
