...
{block name='step_content'}
            ...
            {foreach from=$module_options item="option"}
                ...
                {if $option.additionalInformation}
                    <div
                            ...
                            class="info-mode-paiement js-additional-information definition-list additional-information{if $option.id != $selected_payment_option} ps-hidden {/if}"
                    >
    ...
    {if $show_final_summary}
        ...
        <hr class="   ">
    {/if}
    <div id="before_payment_button">
    {hook h="rasHookTplEdit" id="before_payment_button"}
</div>
