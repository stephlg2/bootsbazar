                            ...
                            {foreach from=$cart.vouchers.added item=voucher}
                                <li class="cart-summary-line">
                                    ...
                                    <div class="">
                                        ...
                                        <a href="{$voucher.delete_url}" data-link-action="remove-voucher"><i class="fa-thin fa-xmark"></i></a>
                                    </div>
                                </li>
                            {/foreach}
                        </ul>
                            ...
                            <form class="form__add-voucher" action="{$urls.pages.cart}" data-link-action="add-voucher" method="post">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-primary">{l s='OK' d='Shop.Theme.Actions'}</button>
                                    </div>
                                </div>
                            </form>
                        {/block}
