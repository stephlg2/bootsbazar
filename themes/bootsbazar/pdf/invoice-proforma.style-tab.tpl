...
{assign var=color_border_lighter value="#666666"}
...
<style>
	...
	table#summary-tab > tr > th {
		border-top: 1pt solid {$color_border};
	}
	table#summary-tab > tr > td {
		/*border-top: 1pt solid {$color_border};*/
		border-bottom: 1pt solid {$color_border};
	}
	table#total-tab {
		padding: {$table_padding};
		border: 1pt solid {$color_border};
	...
	tr.product td {
		border-top: 1pt solid {$color_border};
		border-bottom: 1pt solid {$color_border_lighter};
	}
